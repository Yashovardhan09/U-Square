...
const Home = () => {
    ...
    <div className="h-auto">
      ...
      <div className="h-screen relative flex flex-col justify-center items-center bg-black pt-20">
        ...
        <div className="relative max-w-4xl px-4 text-center z-20">
          <h1 className="text-6xl font-extrabold text-white mb-4 transition-all duration-300">
            Learn Salesforce & Full Stack Web Development From Scratch
          </h1>
          <p className="text-xl font-medium text-white mt-4 mb-8 transition-all duration-300">
          ...
          <Link to="/full-stack-course">
            <button className="bg-black text-white px-8 py-4 rounded-md text-lg font-medium transition-all duration-300 backdrop-blur-md bg-opacity-30 hover:bg-opacity-50 border border-opacity-50  hover:text-blue-600">
              View Course
            </button>
          </Link>
        </div>
      ...
      {/* About Section */}
      <div className="bg-black text-white py-12 flex justify-center items-center space-x-6">
  <img 
  ...
  />
      ...
      <div className="bg-black text-white py-8 flex justify-center">
        <div className="max-w-3xl text-center px-6">
          <p className="text-4xl font-extrabold text-white shadow-lg">
            Why Choose Us?
          </p>
        </div>
      </div>
  ...
  <div className="max-w-6xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-6">
    {/* Feature Cards */}
    {[
  ...
  <div className="max-w-6xl mx-auto px-6">
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      {[
        ...
        <div 
          key={index} 
          className="bg-black bg-opacity-40 backdrop-blur-md border border-white/5 rounded-lg shadow-lg p-6 flex flex-col items-center transform transition-all duration-300 hover:scale-105 hover:bg-opacity-50"
        >
...
<div className="bg-black backdrop-blur-lg py-12 flex justify-center">
  <div className="text-center max-w-4xl px-6">
    <div className="inline-block border-t border-white/20 border-opacity-30 pt-4">
